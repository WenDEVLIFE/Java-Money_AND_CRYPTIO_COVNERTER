...
public class TWD_TO_PHP {
	...
	private void initialize() {
		...
		JLabel lblNewLabel_1_1 = new JLabel("TAIWAN DOLLAR TO PHP");
		lblNewLabel_1_1.setForeground(Color.WHITE);
		lblNewLabel_1_1.setFont(new Font("Tw Cen MT Condensed Extra Bold", Font.PLAIN, 30));
		lblNewLabel_1_1.setBounds(311, 11, 305, 65);
		panel_1.add(lblNewLabel_1_1);
		
		JLabel lblNewLabel_2 = new JLabel("");
		lblNewLabel_2.setIcon(new ImageIcon("C:\\JAVA_ECLIPSE\\WENDEV_MONEY_AND_CRYPTO_CONVERTER\\src\\icons8-taiwan-dollar-64.png"));
		lblNewLabel_2.setBounds(240, 11, 73, 65);
		panel_1.add(lblNewLabel_2);
		
		JLabel lblNewLabel_1_1_1 = new JLabel("ENTER A AMOUNT OF TWD");
		lblNewLabel_1_1_1.setForeground(Color.WHITE);
		lblNewLabel_1_1_1.setFont(new Font("Tw Cen MT Condensed Extra Bold", Font.PLAIN, 30));
		lblNewLabel_1_1_1.setBounds(93, 102, 315, 65);
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				double TWD = Double.parseDouble(textField.getText());
				double php = TWD * 1.79;
				try {
					File file = new File("src\\TAIWAN.wav");
